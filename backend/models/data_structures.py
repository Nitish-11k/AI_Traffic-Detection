...
class VehicleTracker:
    ...
    def __init__(self, vehicle_id: str, initial_bbox: BoundingBox):
        ...
        # --- NEW: Track specific violations to avoid duplicates ---
    ...
    def has_violation(self, violation_type: str) -> bool:
        """Check if this specific violation was already recorded for this vehicle"""
        return violation_type in self.recorded_violations

    def add_violation(self, violation_type: str):
        """Mark this violation as recorded"""
        self.recorded_violations.add(violation_type)
